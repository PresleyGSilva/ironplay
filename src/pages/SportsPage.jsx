  ...
  return (
    <>
      ...
      <div className="container py-12 md:py-20 text-white">
        ...
        >
          📺t Brasileirão, Champions, UFC e muito mais...
        </motion.h1>
        ...
        >
          Tenha acesso a todos os canais ESPORTIVOS e assista os jogos do seu time do coração no conforto da sua casa. No IronPlay você conta com todos os canais esportivos, podendo assistir também, Basquete, Formula 1, UFC e muito mais…
        </motion.p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
          {loading ? (
            ...
            <p className="text-lg text-[hsl(var(--highlight))]">Nenhuma notícia de esporte disponível no momento.</p>
          )}
        </div>
